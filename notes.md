...
Еще момент: на iOS версии >= 15.7.9 проект корректно ототбражается в браузере на момент коммита 17ca2ea9 от 25.12.24 14:52, можно запустить npm i но главное использовать именно тот package-lock.json что там лежит иначе получим белый экран.
